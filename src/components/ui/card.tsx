...
function Card({ className, children, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="card"
      className={cn(
        "relative rounded-xl glass-morphism glass-hover glare-effect group flex flex-col gap-6 py-6 shadow-lg",
        className
      )}
      {...props}
    >
...
function CardTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("leading-none font-semibold text-white/95 group-hover:text-white transition-colors duration-300", className)}
      {...props}
    />
  )
}
...
function CardDescription({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("text-white/70 text-sm group-hover:text-white/80 transition-colors duration-300", className)}
      {...props}
    />
  )
}
